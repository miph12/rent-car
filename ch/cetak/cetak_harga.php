    ...
    <center><table width="1000">
        <tr>
         ...
         <div class="gambar">   <img src="../cetak/img.png" width="105" hspace="1" align="left"> </div>
            ...
            <CENTER><h2 class="title">PT. GRIYA SMART NUSANTARA</h2></CENTER>
        ...
        <CENTER><B>LAPORAN DATA HARGA</B></CENTER>
        
        <?php
        include ("../koneksi.php");
        $query= mysql_query("select * from tb_harga");
            ...
            <tbody>
                ...
                //$no++;
                    ...
                    <tr class="">
                        ...
                        <td align="center"><?php echo $data['id_harga'];?></td>
                        <td><?php echo $data ['type_harga'];?></td>

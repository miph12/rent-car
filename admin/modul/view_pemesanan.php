...
if($_GET['act']=='konfir'){
    ...
    mysql_query("update tb_pemesanan set status = 'Y' where id_pemesanan = '$kode_pesan' ")or die(mysql_error());
    echo '<meta http-equiv="refresh" content="0; url=index2.php?page=modul/view_pemesanan ">';    
}
